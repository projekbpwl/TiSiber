                  ...
                  <div class="panel-body">
                      <div class="col-md-6 col-sm-12">
                        ...
                        <p class="animated fadeInDown">
                        	Data Mahasiswa <span class="fa-angle-right fa"></span> Mahasiswa</p>
                    </div>
                  </div>                    
                </div>
			...
			<div class="col-md-12">
                <div class="col-md-12">
                  <div class="panel panel-primary">
                    <div class="panel-heading"><h3 style="color: white">Data User</h3></div>
						            <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="datatables-example" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                    	...
                                    	include 'config.php';
											$no=1;
											$sql = mysqli_query($db,"SELECT * FROM user where hak_akses='member'");
										...
										<tr>
											...
											<td><div align="center"><?php echo $data['jenis'];?></div></td>
											<td><div align="center"><?php echo $data['alamat'];?></div></td>
											<td><div align="center"><?php echo $data['no_telp'];?></div></td>
                                            <td><div align="center"><?php echo $data['email'];?></div></td>
											<td>
												<a href="editmahasiswa.php?id=<?php echo $data['idu']; ?>" class="btn btn-info">Edit</a>
												<a onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data Ini?')" href="hapusmahasiswa.php?id=<?php echo $data['idu']; ?>" class="btn btn-danger">Hapus</a>
											</td>
										</tr>
										<?php }?>
                                    </tbody>
